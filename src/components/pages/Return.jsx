...
export default function Return() {
    ...
    const [successMessage, setSuccessMessage] = useState('') // Erfolgsnachricht-Status

    const [allProducts, setAllProducts] = useState([])
    const [loadingProducts, setLoadingProducts] = useState(true)
    const [fetchError, setFetchError] = useState('')

    // Laden aller Produkte beim Mounten der Komponente
    useEffect(() => {
    ...
    // Hinzufügen eines neuen Produktfeldes
    const addProduct = () => {
        setProducts([...products, { productId: '', quantity: 1, reason: '' }])
        setSuccessMessage('') // Erfolgsnachricht zurücksetzen
    }

    // Entfernen eines Produktfeldes
    const removeProduct = (index) => {
        setProducts(products.filter((_, i) => i !== index))
        setSuccessMessage('') // Erfolgsnachricht zurücksetzen
    }

    // Handhabung von Änderungen in den Produktfeldern
    ...
    // Handhabung von Änderungen im Status
    ...
    // Handhabung von Änderungen im Rückgabegrund
