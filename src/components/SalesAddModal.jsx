...
export default function SalesAddModal({ closeModal, onSubmit }) {
    ...
    const [errors, setErrors] = useState([{ productId: '', price: '', quantity: '' }]) // Fehlerzustand
    ...
    const handleProductChange = (index, field, value) => {
        ...
        // Fehler für das aktuelle Feld zurücksetzen, wenn der Benutzer eine Änderung vornimmt
    ...
    const validateForm = () => {
        ...
        // Prüfen, ob es irgendwelche Fehler gibt
    ...
    // Entferne die Erfolgsmeldung nach einigen Sekunden
    useEffect(() => {
        if (successMessage) {
