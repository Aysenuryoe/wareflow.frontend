...
const EditModal = ({ closeModal, onSubmit, defaultValue }) => {
    ...
    const [successMessage, setSuccessMessage] = useState('') // Zustand für Erfolgsmeldung
    const [submitError, setSubmitError] = useState('') // Zustand für allgemeine Fehler
    ...
    const validateForm = () => {
        ...
        Object.keys(product).forEach((field) => {
            ...
            if (field !== 'description') {
                ...
                // Beschreibung ist optional, aber wenn vorhanden, validieren
                const error = validateField(field, product[field])
                if (error) {
                    newErrors[field] = error
                }
    ...
    const handleSubmit = async (e) => {
        ...
        if (validateForm()) {
            // Konvertiere price und stock zu Zahlen
